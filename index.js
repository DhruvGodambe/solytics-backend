...
const { LIQUIDITY_STATE_LAYOUT_V4, LiquidityStateV4, MAINNET_PROGRAM_ID } = require('@raydium-io/raydium-sdk');
...
async function startMonitoringPools() {
...
async function handleAmmTransaction(accountInfo, programType) {
...
async function handleClmmTransaction(transaction, signature) {
...
async function handleCpmmTransaction(transaction, signature) {
    const { transaction: { message }, meta } = transaction;
...
async function evaluateNewPool(accountId, poolState, programType) {
